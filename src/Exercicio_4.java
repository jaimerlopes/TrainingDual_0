...
public class Exercicio_4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         * Três amigos - Carlos, André e Filipe – foram jantar e decidiram dividir
         * igualmente a conta do restaurante.
         * Escreva um programa em Java que leia o valor total da conta e calcule e
         * imprima quanto cada um deve pagar,
         * mas fazendo com que o Carlos e o André não paguem cêntimos. Ex: uma conta de
         * 101,53€ resulta em 33,00€ para
